...
public class BankAccount {
   public static void main(String args[]){
    ...
    // bacc.password = "whynot";//yha pr nhi pta isko password word kya cheez hai qki ye private h 
    // System.out.println(setpassword("hello"));//ye bhi nhi hoga iske liye nya keyword use hoga which is get $set

//getter and setter 
//yha pr agr hm private bhi kr de toh bhi get or set ki help se private values ko change kiya ja ksta hai 
